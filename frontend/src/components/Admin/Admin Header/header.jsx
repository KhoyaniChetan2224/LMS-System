      ...
      >
        ...
        <nav className="flex-1 space-y-2">
          {[
            ...
            { icon: <IoCalendar />, name: "Class and Course Schedule", path: "/admin/schedule-class" },
            { icon: <MdUpcoming /> , name: "create class schedule", path: "/admin/create-class-schedule" },
            { icon: <MdAssignment />, name: "My Homework", path: "/admin/homework" },
            { icon: <MdHistory />, name: "My Past Classes", path: "/admin/past-classes" },
            { icon: <MdQuiz />, name: "Test Yourself", path: "/admin/test-yourself" },
            { icon: <MdReport />, name: "Progress Report", path: "/admin/progres-report" }
          ].map((item) => (
            <Link
              key={item.name}
              to={item.path}
